...
<div class="min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 ">
  <div class="max-w-md w-full space-y-8">
    <div>
      <h2 class="mt-6 text-center text-xl font-extrabold text-gray-900">CONNECTEZ-VOUS À VOTRE COMPTE</h2>
    ...
    <form [formGroup]="form" class="mt-8 space-y-6" action="#" method="POST">
      ...
      <div>
        <button (click)="login()"type="submit" class="group relative w-full flex justify-center py-2 px-4 border border-black text-sm font-medium rounded-md text-black  hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black-500">
