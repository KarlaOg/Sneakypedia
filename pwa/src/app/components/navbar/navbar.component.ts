...
@Component({
  selector: 'app-navbar',
  template: `
    <nav class="bg-white border-gray-200 px-2 sm:px-4 pl-2 rounded p-3  shadow  zinc:300  h-16 fixed top-0 left-0 right-0 z-40">
      <div class="container flex flex-wrap justify-between items-center mx-auto">
        <a href="#" class="flex items-center">
          <span class="self-center text-xl text-gray-800 font-semibold whitespace-nowrap ml-2">SNEAKYPEDIA <sub class="text-xs text-orange-600">by Sneakies</sub></span>
