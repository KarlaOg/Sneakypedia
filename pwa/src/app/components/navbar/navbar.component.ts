...
@Component({
  selector: 'app-navbar',
  template: `
    <nav class="bg-white border-gray-200 p-3 sm:px-4  shadow  zinc:300  h-16 fixed top-0 left-0 right-0 z-50	">
      <div
      ...
      >
        ...
        <button
          ...
          type="button"
          class="inline-flex items-center p-2 ml-3 text-sm text-black -lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-black dark:hover:bg-gray-700 dark:focus:ring-gray-600"
